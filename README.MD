...
*Antes de continuar:* Si nosotros miramos index.php y actions.php tendremos funciones basdas en formularios con __*$_GET*__ ya estipuladas para ejemplo.
...
Un caso práctico es el siguiente, donde obtenemos el detalle de una venta realizada con mediante IPN, en esta oportunidad enviamos el numero de la venta por __*$_REQUEST*__
