...
Un caso práctico es el siguiente, donde obtenemos el detalle de una venta realizada mediante IPN, en esta oportunidad enviamos el numero de la venta por __*$_REQUEST*__
